...
- **Sync Contacts** -- triggers a one-way import of Google Contacts into RealCRM.
...
- **LinkedIn CSV import** -- supports the export format from LinkedIn's "Download your data" feature. Columns are mapped automatically to RealCRM contact fields.
